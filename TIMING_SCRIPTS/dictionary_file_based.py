...
if __name__ == '__main__':
    ...
    try:
        ...
        print(f"BUILD lasted {runtime} seconds")
    ...
    try:
        ...
        for line in command_file:
            ...
            if command == 'S':
                ...
                print(f"SEARCH lasted {runtime} seconds")
            ...
            # add
                ...
                if not agent.add_word_frequency(word_frequency):
                    ...
                    print(f"ADD lasted {runtime} seconds")
            ...
            # delete
                ...
                if not agent.delete_word(word):
                    ...
                    print(f"DELETE lasted {runtime} seconds")
            ...
            # check
                ...
                print(f"AUTOCOMPLETE lasted {runtime} seconds")
